                                     ...
                                     <table class="table table-bordered">
                                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    $search = "SELECT DISTINCT school_district FROM registered  WHERE school_type='REGISTERED_ADVANCE'";
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="student_alevel?district=<?php echo $district; ?>"><?php echo strtoupper ($row['school_district']);?></a></td>
                                                                <td>
                                                                    <a href="student_alevel?district=<?php echo $district; ?>">
                                                                    <?php
                                                        ...
                                                        <tr class="odd gradeX" style="font-size: 13px;">
                                                            ...
                                                            <td><center>
                                                               <a title="Add students" href="add_student?add=<?php echo $school_no; ?>" class=""><i class="fa fa-plus" style="color:green;"> </i> Add</a>
                                                                ...
                                                                <a title="Asign subject to students" href="assign_alevelsubject?no=<?php echo $school_no; ?>" class="btn btn-xs btn-warning">subject</a>
