                                        ...
                                        <!-- id="dataTables-example" FOR TABLE DATA-->
                                            <thead style="font-size: 13px">
                                                <tr>
                                                    ...
                                                    <th>
                                                    <select name="subject_id" class="form-control" style="font-size: 12px" required>
                                                                    <option disabled selected value="">-select subject-</option>
                                                                    <?php
                                                                        $sql_department = "SELECT * FROM tbl_primary_subject WHERE class_level='a_level'  order by subject_name ASC";
                                                    ...
                                                    <th rowspan="2" style="width: 240px">Subject Asigned</th>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <?php
                                                                    $get_data = "SELECT * FROM tbl_student JOIN tbl_student_primary_subject JOIN tbl_primary_subject ON tbl_student.student_id = tbl_student_primary_subject.student_id AND tbl_primary_subject.subject_id = tbl_student_primary_subject.subject_id WHERE tbl_student.student_id='$student'";
                                                                    $run = mysqli_query($con, $get_data);
                                                                    while($row2 = mysqli_fetch_array($run)){
                                                                        echo "<i style='font-size:12px;'>".strtolower($row2['subject_name']."</i>".",");
                                                                    }
                                                                ?>
                                                            </td>
