...
?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                             <h5 class="page-header" style="text-align: center;">ALL REGISTERED STUDENT PER EXAMINATION</h5>
                        </div>
                        <!-- /.col-lg-12 -->
                        <?php
                                    if(!empty($_GET['del'])) {
                                        ...
                                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="isalalevel?district=<?php echo $district; ?>"><?php echo strtoupper($row['school_district']);?></a></td>
                                                                <td>
                                                                    <a href="isalalevel?district=<?php echo $district; ?>">
                                                                    <?php
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        <tr class="odd gradeX">
                                                           ...
                                                           <a title="View Marks" href="isal?no=<?php echo $school_no; ?>" class="btn btn-xs btn-warning"> View Students</a>
