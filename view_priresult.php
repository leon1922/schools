        ...
        .input{
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="page-header" style="text-align: center;">VIEW RESULTS OF
                            <?php
                                ...
                                while($row = mysqli_fetch_array($run_query)){
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $row['school_no'] .", ". $row['school_name'] ." PRIMARY SCHOOL (".$row['school_district'].")";?></td>
                                        </tr>
                                <?php } ?>
                            </h5>
                        </div>
...
$sql_students = "SELECT * FROM `tbl_student_primary` WHERE school_no='$school_no' ORDER BY first_name";
