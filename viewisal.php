          ...
          -moz-appearance:textfield;
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="page-header" style="text-align: center;"> VIEW STUDENTS 
                            <?php
                                ...
                                <?php } ?>
                                <h5 style="text-align: right;"> <button type="button" class="btn btn-outline-secondary btn-sm" onclick="printDiv('print-content')" value="print a div!">PRINT STUDENTS</button></h5>  
                                       ...
                                       <!-- <td>students registered</td> -->
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="viewisal?subject_code=<?php echo $subject_code.'&no='.$test ; ?>"><?php echo $row['subject_name'];?></a></td>
                                                               <!-- <td>
                                                                    <?php
                        ...
                        <div class="col-lg-9">
                            <div class="panel panel-default">
                                ...
                                while($row = mysqli_fetch_array($run_query)){
                                    $school_no=openssl_encrypt ($row['school_no'], $ciphering, $decryption_key, $options, $decryption_iv);
                                    ?>
                                 <?php echo strtoupper( $row['school_name'])  ." <br> ".strtoupper($row['school_district'])."";?> 
                                 <?php } ?>
                                <?php
                                     include('include/config.php');
                                     $subject_code=@openssl_decrypt ($_GET['subject_code'], $ciphering, $decryption_key, $options, $decryption_iv);
                                  ...
                                  <?php
                                     include('include/config.php');
                                     $subject_code=@openssl_decrypt ($_GET['subject_code'], $ciphering, $decryption_key, $options, $decryption_iv);
                                     $find = "SELECT DISTINCT subject_date FROM tbl_primary_subject WHERE subject_code = '$subject_code'";
                                     $go = mysqli_query($con, $find);
                                     while($row11 = mysqli_fetch_array($go)){
                                        echo strtoupper($row11['subject_date']);
                                     }
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <center><table border="1px" style="align-self: center;">
                                            <tr>
                                                <td>Invigilator's Name:</td>
