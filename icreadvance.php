                                        ...
                                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="icreadvance?district=<?php echo $district; ?>"><?php echo strtoupper($row['school_district']);?></a></td>
                                                                <td>
                                                                    <a href="icreadvance?district=<?php echo $district; ?>">
                                                                    <?php
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        <tr class="odd gradeX">
                                                           ...
                                                           <a title="View report" href="view_alevelreport?view=<?php echo $school_no; ?>" class="btn btn-xs btn-warning"> View report</a>
