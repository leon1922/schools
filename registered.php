...
?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="page-header" style="text-align: center;">ALL STUDENTS REGISTERED<br><i><b style="color:red">Please do not edit REGISTERED</b></i></h5>
                        </div>
                        <!-- /.col-lg-12 -->
                        <?php
                                    if(!empty($_GET['del'])) {
                                        ...
                                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="registered?district=<?php echo $district; ?>"><?php echo strtoupper ($row['school_district']);?></a></td>
                                                                <!--<td>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <?php
                                                    include('include/config.php');
                                                    $district=@openssl_decrypt ($_GET['district'], $ciphering, $decryption_key, $options, $decryption_iv);
                                                    $search = "SELECT * FROM registered WHERE school_district='$district' ORDER BY school_name ASC";
                                                    $run_query = mysqli_query($con, $search);
                                                    $i = 1;
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        <tr class="odd gradeX" style="font-size: 13px;">
                                                            ...
                                                            <td style="text-align: center;"><a title="View students" href="view_primary_student?add=<?php echo $school_no; ?>" class="">
                                                                <?php
                                                                    $count = "SELECT * FROM tbl_student_registered WHERE school_no = '$row[school_no]'";
                                                            ...
                                                            <td><center>
                                                                <a title="Add students" href="add_primary_student?add=<?php echo $school_no; ?>" class=""><i class="fa fa-plus" style="color:green;"> </i> Add</a>
