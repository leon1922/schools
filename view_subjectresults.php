          ...
          -moz-appearance:textfield;
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="page-header" style="text-align: center;"> VIEW MARKS 
                            <?php
                                ...
                                <?php } ?>
                                <h5 style="text-align: right;"> <button type="button" class="btn btn-outline-secondary btn-sm" onclick="printDiv('print-content')" value="print a div!">PRINT MARKS</button></h5>  
                                       ...
                                       <!-- <td>students registered</td> -->
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="view_subjectresults?subject_code=<?php echo $subject_code.'&no='.$test ; ?>"><?php echo $row['subject_name'];?></a></td>
                                                               <!-- <td>
                                                                    <?php
                        ...
                        <div class="col-lg-9">
                            <div class="panel panel-default">
                                ...
                                while($row = mysqli_fetch_array($run_query)){
                                    $school_no=openssl_encrypt ($row['school_no'], $ciphering, $decryption_key, $options, $decryption_iv);
                                    ?>
                                 <?php echo strtoupper( $row['school_name'])  ."  ".strtoupper($row['school_district'])."";?> 
                                 <?php } ?>
                                <?php
                                     include('include/config.php');
                                     $subject_code=@openssl_decrypt ($_GET['subject_code'], $ciphering, $decryption_key, $options, $decryption_iv);
