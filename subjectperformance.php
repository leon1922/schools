                                        ...
                                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="subjectperformance?district=<?php echo $district; ?>"><?php echo strtoupper($row['school_district']);?></a></td>
                                                                <td>
                                                                    <a href="subjectperformance?district=<?php echo $district; ?>">
                                                                    <?php
