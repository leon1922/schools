                                        ...
                                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="alevelsubjectperformance?district=<?php echo $district; ?>"><?php echo strtoupper($row['school_district']);?></a></td>
                                                                <td>
                                                                    <a href="alevelsubjectperformance?district=<?php echo $district; ?>">
                                                                    <?php
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        <tr class="odd gradeX">
                                                           ...
                                                           <a title="View Marks" href="view_subjectresults?no=<?php echo $school_no; ?>" class="btn btn-xs btn-warning"> View marks</a>
