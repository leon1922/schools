                                        ...
                                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="alevelresult?district=<?php echo $district; ?>"><?php echo strtoupper($row['school_district']);?></a></td>
                                                                <td>
                                                                    <a href="alevelresult?district=<?php echo $district; ?>">
                                                                    <?php
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <!-- <td class="center"><?php echo $i ?></td> -->
                                                            <td>
                                                                 <!--<a title="view result" href="view_alevelresult?view=<?php echo $school_no; ?>"> <span class="fa fa-files-o"></span> <?php echo strtoupper($row['school_no'])?> </a>-->
                                                                 <?php echo strtoupper( $row['school_no'])?>
                                                            </td>
