...
?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                             <h5 class="page-header" style="text-align: center;">ALL REGISTERED EXAMINATIONS RESULTS A-LEVEL</h5>
                        </div>
                        <!-- /.col-lg-12 -->
                        <?php
                                    if(!empty($_GET['del'])) {
                                ...
                                <div class="panel-body">
                                     <table class="table table-bordered">
                                        <tr>
                                                ...
                                                <?php
                                                    include('include/config.php');
                                                    $search = "SELECT DISTINCT school_district FROM tbl_school_p WHERE class_level='a_level' ORDER BY school_district ASC";
                                                    $run_query = mysqli_query($con, $search);
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        $district=openssl_encrypt ($row['school_district'], $ciphering, $encryption_key, $options, $encryption_iv);
                                                        ?>
                                                            <tr>
                                                                <td><a href="printdivisionalevel?district=<?php echo $district; ?>"><?php echo strtoupper($row['school_district']);?></a></td>
                                                                <td>
                                                                    <a href="printdivisionalevel?district=<?php echo $district; ?>">
                                                                    <?php
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        <tr class="odd gradeX">
                                                           ...
                                                           <a title="View results" href="view_divisionresultalevel?view=<?php echo $school_no; ?>" class="btn btn-xs btn-warning"> View results</a>
