                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        if(isset($_POST['insert_marks'])){
                            ...
                            $find_subject_id = "SELECT * FROM tbl_subject WHERE subject_code = '$subject_code'";
                            ...
                            while($check = mysqli_fetch_array($true_chek)){
                                ...
                                for ($i=0; $i < $try; $i++) {
                                    ...
                                    $add_mark = "UPDATE tbl_student_subject SET marks ='$newmarks1' WHERE student_subject_id = '$countStudentID1' ";
                                ...
                                <div class="panel-body">
                                     <table class="table table-bordered">
                                        <tr>
                                                ...
                                                <?php
                                                    include('include/config.php');
                                                    $search = "SELECT  distinct tbl_school.school_no, tbl_school.school_name, tbl_subject.subject_code, tbl_subject.subject_name FROM tbl_school JOIN tbl_student JOIN tbl_subject JOIN tbl_student_subject ON 
                                                    tbl_school.school_no = tbl_student.school_no AND tbl_student.student_id = tbl_student_subject.student_id AND
                                                     tbl_subject.subject_id = tbl_student_subject.subject_id WHERE tbl_school.school_no='$school'";
                                                    $run_query = mysqli_query($con, $search);
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <!-- <td>
                                                                    <?php
                                                                            $school_count = "SELECT  * FROM tbl_school JOIN tbl_student JOIN tbl_subject JOIN tbl_student_subject ON 
                                                                            tbl_school.school_no = tbl_student.school_no AND tbl_student.student_id = tbl_student_subject.student_id AND
                                                                             tbl_subject.subject_id = tbl_student_subject.subject_id WHERE tbl_subject.subject_code='$subject_code'";
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example" >
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    // old search query
                                                    // $search = "SELECT * FROM tbl_student JOIN tbl_subject JOIN tbl_student_subject ON tbl_student.student_id = tbl_student_subject.student_id AND tbl_subject.subject_id = tbl_student_subject.subject_id 
                                                    
                                                    //new search query
                                                    $search = "SELECT * FROM tbl_student_subject  
                                                            JOIN tbl_subject ON tbl_subject.subject_id = tbl_student_subject.subject_id 
                                                            JOIN tbl_student  ON tbl_student.student_id = tbl_student_subject.student_id 
                                                        WHERE 
                                                            tbl_student.school_no='$school_no' AND
                                                            tbl_subject.subject_code='$subject_code'";
                                                    $run_query = mysqli_query($con, $search);
                                                    $i = 1;
                                                    while($row = mysqli_fetch_assoc($run_query)){
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td><input type="number" min="0" max="100" name="marks[]" class="form-control" style="width:65px;"  value="<?php echo $row['marks']?>"></td>
                                                            </tr>
