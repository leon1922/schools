...
?>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="page-header">All Registered Schools</h4>
                        </div>
                        <!-- /.col-lg-12 -->
                        <?php
                                    if(!empty($_GET['del'])) {
                                        ...
                                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($run_query)){
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><a href="schools_in_district?district=<?php echo $district; ?>"><?php echo strtoupper( $row['school_district']);?></a></td>
                                                                <td>
                                                                    <a href="schools_in_district?district=<?php echo $district; ?>">
                                                                    <?php
