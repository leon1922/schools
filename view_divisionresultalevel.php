...
?>
                                ...
                                <h5  style="text-align: center;"><b>PRESIDENT'S OFFICE-RALG<br>KILAKALA SECONDARY SCHOOL<br>P.O.BOX 40 MOROGORO<br><?php
                                ...
                                <?php } ?>
                                <br>Email:<i>kilakalass1957@gmail.com,</i> Website:<i>www.kilakalasps.ac.tz </i><br>
...
echo "</td>";
echo "<td>";
if($total_pnt >= 3 && $total_pnt <=9){
    echo "I";
}
if($total_pnt >= 10 && $total_pnt <= 12){
    echo "II";
}
if($total_pnt >= 13 && $total_pnt <=17){
    echo "III";
}
if($total_pnt >= 18 && $total_pnt <= 19){
    echo "IV";
}
if($total_pnt >= 20 && $total_pnt <= 21){
    echo "0";
}
echo "</td>";
?>
